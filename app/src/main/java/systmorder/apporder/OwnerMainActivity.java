...
public class OwnerMainActivity extends AppCompatActivity implements OnMenuTabClickListener {
    ...
    public void onMenuTabSelected(@IdRes int menuItemId) {
        ...
        if (menuItemId == R.id.btmBarDashboard){
            ...
            OwnerTableTab fragOwnerDashboardTab = new OwnerTableTab();
        ...
        } else if (menuItemId == R.id.btmBarOrders){

            OwnerOrderTab fragOwnerOrderTab = new OwnerOrderTab();
            transaction.replace(R.id.owner_activity_main, fragOwnerOrderTab);;
            transaction.commit();
